...
namespace QL_BanHang.View
{
    public partial class frmHoaDon : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            dtDSCT.Rows.Clear();
            if(!dtDSCT.Columns.Contains("MaHD"))
            {
                dtDSCT.Columns.Add("MaHD");
            }
            if (!dtDSCT.Columns.Contains("HangHoa"))
            {
                dtDSCT.Columns.Add("HangHoa");
            }
            if (!dtDSCT.Columns.Contains("DonGia"))
            {
                dtDSCT.Columns.Add("DonGia");
            }
            if (!dtDSCT.Columns.Contains("SoLuong"))
            {
                dtDSCT.Columns.Add("SoLuong");
            }
            if (!dtDSCT.Columns.Contains("ThanhTien"))
            {
                dtDSCT.Columns.Add("ThanhTien");
            }

            cmbHH_SelectedIndexChanged(null, null);
        }
