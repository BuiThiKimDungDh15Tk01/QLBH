...
namespace QL_BanHang.Model
{
    class ChiTietMod
    {
        ...
        public bool DelDataHangHoa(string maHH)
        {
            cmd.CommandText = "Delete tb_CTHD Where MaHH = '" + maHH + "'";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = con.Connection;
            try
            {
        ...
        public bool DelDataHoaDon(string maHD)
        {
            cmd.CommandText = "Delete tb_CTHD Where MaHD = '" + maHD + "'";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = con.Connection;
            try
            {
